...
$ConfigPath = Join-Path $PackageRoot "configs\system.dualmode_mode1.local.json"
...
$TrainRunName = "${Tag}_dualmode_mode1_train"
$EvalRunName = "${Tag}_dualmode_mode1_eval"
...
Write-Host "`nMode1 train+eval command sequence completed."
